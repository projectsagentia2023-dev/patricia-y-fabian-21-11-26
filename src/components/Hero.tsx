    ...
    <section className="relative min-h-screen overflow-hidden">
      <div className="absolute inset-0">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-green-900/40 via-black/30 to-green-50/95" />
      </div>

      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-24 text-center">
        <p className="animate-fade-in mb-4 font-serif text-sm uppercase tracking-[0.4em] text-green-300 md:text-base">
          {eventData.title}
        </p>
        ...
        <h1 className="animate-fade-in-up font-serif text-5xl font-light leading-tight text-white md:text-7xl lg:text-8xl">
          ...
          <span className="mx-3 inline-block text-green-400">&amp;</span>
        ...
        <button
          ...
          className="animate-fade-in-up mt-12 rounded-none border border-green-700 bg-green-800/40 px-10 py-4 font-serif text-sm uppercase tracking-[0.25em] text-green-100 backdrop-blur-sm transition-all duration-500 hover:bg-green-700 hover:text-white"
        >
      ...
      <div className="absolute bottom-8 left-1/2 z-10 -translate-x-1/2 animate-bounce">
        <div className="h-10 w-6 rounded-full border-2 border-green-400/60 p-1">
          <div className="mx-auto h-2 w-1 rounded-full bg-green-400" />
        </div>
      </div>
    </section>
  );
