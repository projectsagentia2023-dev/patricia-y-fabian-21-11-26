    ...
    <section className="relative min-h-screen overflow-hidden">
      <div className="absolute inset-0">
        <Image
          ...
          sizes="100vw"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/30 to-beige-100/95" />
      </div>
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <button
          ...
          className="animate-fade-in-up mt-12 rounded-none border border-gold-400 bg-gold-400/10 px-10 py-4 font-serif text-sm uppercase tracking-[0.25em] text-gold-300 backdrop-blur-sm transition-all duration-500 hover:bg-gold-400 hover:text-white"
        >
