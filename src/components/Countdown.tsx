...
function TimeBlock({ value, label }: { value: number; label: string }) {
  return (
    <div className="group flex flex-col items-center">
      <div className="relative flex h-20 w-20 items-center justify-center border border-gold-300/40 bg-white shadow-sm transition-all duration-500 group-hover:border-gold-400 group-hover:shadow-md md:h-28 md:w-28">
        <span className="font-serif text-3xl text-beige-900 md:text-5xl">
          {String(value).padStart(2, "0")}
        </span>
        <div className="absolute -bottom-px left-0 h-0.5 w-0 bg-gold-400 transition-all duration-500 group-hover:w-full" />
      </div>
