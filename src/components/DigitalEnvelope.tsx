      ...
      <ScrollReveal>
        <div className="mx-auto max-w-2xl text-center">
          <div className="mb-6 flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-full border border-green-600 bg-white">
          ...
          <div className="mx-auto mb-8 max-w-sm border border-green-200 bg-white p-8 shadow-sm">
            <p className="mb-2 font-serif text-sm uppercase tracking-[0.2em] text-green-700">
              Alias Mercado Pago
            </p>
            <p className="font-serif text-2xl text-green-800">{eventData.mercadoPagoAlias}</p>
          </div>

          <button
            type="button"
            onClick={copyAlias}
            className="border border-green-800 bg-green-800 px-10 py-4 font-serif text-sm uppercase tracking-[0.25em] text-white transition-all duration-500 hover:bg-green-700"
          >
