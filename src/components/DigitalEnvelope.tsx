...
export default function DigitalEnvelope() {
  ...
  return (
    <section className="bg-beige-50 px-6 py-20">
      <ScrollReveal>
        <div className="mx-auto max-w-2xl text-center">
          <div className="mb-6 flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-full border border-gold-300 bg-white">
          ...
          <div className="mx-auto mb-8 max-w-sm border border-gold-200 bg-white p-8 shadow-sm">
            <p className="mb-2 font-serif text-sm uppercase tracking-[0.2em] text-beige-600">
              Alias Mercado Pago
            </p>
            <p className="font-serif text-2xl text-gold-600">{eventData.mercadoPagoAlias}</p>
          </div>

          <button
            type="button"
            onClick={copyAlias}
            className="border border-gold-400 bg-gold-400 px-10 py-4 font-serif text-sm uppercase tracking-[0.25em] text-white transition-all duration-500 hover:bg-gold-500"
          >
