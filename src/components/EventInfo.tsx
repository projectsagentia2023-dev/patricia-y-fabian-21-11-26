...
export default function EventInfo() {
  return (
    <section className="bg-green-50/60 px-6 py-20">
      <ScrollReveal>
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="group border border-green-200/80 bg-white p-8 transition-all duration-500 hover:border-green-700 hover:shadow-lg">
              <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-green-600">
          ...
          <a
            ...
            className="mt-12 inline-block border border-green-800 bg-green-800 px-10 py-4 font-serif text-sm uppercase tracking-[0.25em] text-white transition-all duration-500 hover:bg-green-700"
          >
            Cómo llegar
          </a>
        </div>
