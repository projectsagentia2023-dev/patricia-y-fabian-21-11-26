      ...
      <ScrollReveal>
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="group border border-beige-300/60 bg-white p-8 transition-all duration-500 hover:border-gold-300 hover:shadow-lg">
              <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-gold-300">
          ...
          <a
            ...
            className="mt-12 inline-block border border-gold-400 bg-gold-400 px-10 py-4 font-serif text-sm uppercase tracking-[0.25em] text-white transition-all duration-500 hover:bg-gold-500"
          >
            Cómo llegar
          </a>
        </div>
